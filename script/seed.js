...
async function seed () {
  ...
  const prices = await Promise.all([
    ...
    Price.create({
      // id: 10,
       price: 12.00, productId: 10}),
    Price.create({
      // id: 11,
       price: 24.00, productId: 11}),
    Price.create({
      // id: 12,
       price: 8.00, productId: 12}),
    Price.create({
      // id: 13,
       price: 10.00, productId: 13}),
    Price.create({
      // id: 14,
       price: 10.00, productId: 14}),
    Price.create({
      // id: 15,
       price: 10.00, productId: 15}),
    Price.create({
      // id: 16,
       price: 12.00, productId: 16}),
    Price.create({
      // id: 17,
       price: 12.00, productId: 17}),
    Price.create({
      // id: 18,
       price: 10.00, productId: 18}),
    Price.create({
      // id: 19,
       price: 20.00, productId: 19})
  ]);
