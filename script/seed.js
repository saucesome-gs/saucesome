...
async function seed () {
  ...
  const brands = await Promise.all([
    Brand.create({
      id: 1,
      name: 'Karma Sauce',
      address: 'Pittsford, NY',
      coordinates: [43.0510379, -77.969716]
    }),
    Brand.create({
      id: 2,
      name: 'Bravado Spice Co',
      address: '7025 W. Tidwell, Houston, Texas 77092',
      coordinates: [29.8493952, -95.4971293]
    }),
    Brand.create({
      id: 3,
      name: 'Dawson\'s Hot Sauce',
      address: 'Hamilton, ON',
      coordinates: [43.2604685, -80.2133298]
    }),
    Brand.create({
      id: 4,
      name: 'Dirty Dick\'s',
      address: 'PO. Box 635, Norwell, Massachusetts 02061',
      coordinates: [42.1507252, -70.8914868]
    }),
    Brand.create({
      id: 5,
      name: 'Queen Majesty',
      address: '23-23 Borden Avenue, Queens, NY 11101',
      coordinates: [40.7401125, -73.9487331]
    }),
    Brand.create({
      id: 6,
      name: 'Homeboy\'s Hot Sauce',
      address: '1334 Van Buren, Phoenix, AZ 85006',
      coordinates: [33.4516621, -112.0554151]
    }),
    Brand.create({
      id: 7,
      name: 'Hot Ones',
      address: '121 Wythe Avenue, Brooklyn, NY 11249',
      coordinates: [40.7202056, -73.9595984]
    }),
    Brand.create({
      id: 8,
      name: 'High River Sauces',
      address: 'Port Washington, NY 11050',
      coordinates: [40.8383868, -73.7652203]
    }),
    Brand.create({
      id: 9,
      name: 'Adoboloco Hot Sauce',
      address: 'Kihei, HI 96753',
      coordinates: [20.7650849, -156.4863116]
    }),
    Brand.create({
      id: 10,
      name: 'Légal Hot Sauce',
      address: 'Brazil',
      coordinates: [-13.702797, -69.686511]
    }),
    Brand.create({
      id: 11,
      name: 'Mellow Habanero',
      address: '669-2432 Hyōgo-ken, Sasayama-shi, Yakamiuchi, 515',
      coordinates: [35.0678125, 135.25223]
    }),
    Brand.create({
      id: 12,
      name: 'Secret Aardvark Trading Co',
      address: 'Portland, OR',
      coordinates: [45.4541379, -122.703812]
    }),
    Brand.create({
      id: 13,
      name: 'Torchbearer Sauces',
      address: 'Mechanicsburg, PA',
      coordinates: [40.258637, -77.0012599]
    }),
  ]);
  // Wowzers! We can even `await` on the right-hand side of the assignment operator
  // and store the result that the promise resolves to in a variable! This is nice!
  ...
  const prices = await Promise.all([
    Price.create({id: 1, price: 10.00, productId: 1}),
    Price.create({id: 2, price: 10.00, productId: 2}),
    Price.create({id: 3, price: 10.00, productId: 3}),
    Price.create({id: 4, price: 10.00, productId: 4}),
    Price.create({id: 5, price: 18.00, productId: 5}),
    Price.create({id: 6, price: 10.00, productId: 6}),
    Price.create({id: 7, price: 10.00, productId: 7}),
    Price.create({id: 8, price: 10.00, productId: 8}),
    Price.create({id: 9, price: 20.00, productId: 9}),
    Price.create({id: 10, price: 12.00, productId: 10}),
    Price.create({id: 11, price: 24.00, productId: 11}),
    Price.create({id: 12, price: 8.00, productId: 12}),
    Price.create({id: 13, price: 10.00, productId: 13}),
    Price.create({id: 14, price: 10.00, productId: 14}),
    Price.create({id: 15, price: 10.00, productId: 15}),
    Price.create({id: 16, price: 12.00, productId: 16}),
    Price.create({id: 17, price: 12.00, productId: 17}),
    Price.create({id: 18, price: 10.00, productId: 18}),
